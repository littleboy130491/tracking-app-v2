...
/**
 * File: app/Livewire/Customer/ExportContainerDetail.php
 * Responsibility: Customer view of one export container plus its journey timeline.
 * What it does:
 * - Shows the container's export details and its chronological journey from
 ...
 *   company's container.
 * How to use: route customer.export-containers.show (opened in a new tab from
 *   the shipment page).
...
class ExportContainerDetail extends Component
{
    public int $containerId;

    public function mount(mixed $exportContainer): void
    {
        $this->containerId = $exportContainer instanceof ExportContainer ? $exportContainer->getKey() : (int) $exportContainer;
    ...
    public function render(): View
    {
        ...
        return view('livewire.customer.export-container-detail', [
            'container' => $container,
            'timeline' => app(ShipmentTimeline::class)->forContainer($container),
        ]);
    }

    private function container(): ExportContainer
    {
