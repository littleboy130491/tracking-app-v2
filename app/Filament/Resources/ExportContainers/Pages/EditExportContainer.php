...
/**
 * File: app/Filament/Resources/ExportContainers/Pages/EditExportContainer.php
 * Responsibility: Edits an export container.
 * What it does:
 ...
 * How to use: Reached by editing an export container.
...
class EditExportContainer extends EditRecord
{
    ...
    {
        foreach (ExportContainer::photoPickers() as $key => $category) {
